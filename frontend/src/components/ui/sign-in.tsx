...
export const SignInPage: React.FC<SignInPageProps> = ({
  title = <span className="font-light text-foreground tracking-tighter">Welcome To Momemtum</span>,
        ...
        <div className="w-full max-w-md">
          <div className="flex flex-col gap-6">
            ...
            <p className="animate-element animate-delay-900 text-center text-sm text-muted-foreground">
              Don't have momemtum, yet? <Link href="/register" className="text-violet-400 hover:underline transition-colors">Create Account</Link>
            </p>
          </div>
        </div>
      </section>
